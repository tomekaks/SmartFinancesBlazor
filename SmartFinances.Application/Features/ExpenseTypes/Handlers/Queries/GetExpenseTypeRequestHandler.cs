...
{
    public class GetExpenseTypeRequestHandler : IRequestHandler<GetExpenseTypeRequest, ExpenseTypeDto>
    {
        private readonly IExpenseTypeFactory _expenseTypeFactory;
        private readonly IUnitOfWork _unitOfWork;

        public GetExpenseTypeRequestHandler(IExpenseTypeFactory expenseTypeFactory, IUnitOfWork unitOfWork)
        {
            _expenseTypeFactory = expenseTypeFactory;
            _unitOfWork = unitOfWork;
        }

        public async Task<ExpenseTypeDto> Handle(GetExpenseTypeRequest request, CancellationToken cancellationToken)
        {
